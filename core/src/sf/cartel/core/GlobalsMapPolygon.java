...
public class GlobalsMapPolygon {
    public static Polygon createJamaycaPolygon() {
    ...
    public static Polygon createQuakamolePolygon() {
    ...
    public static Polygon createBelizePolygon() {
        return new Polygon(
    ...
    public static Polygon createElSalvadorPolygon() {
        return new Polygon(
    ...
    public static Polygon createHondurasPolygon() {
        return new Polygon(
    ...
    public static Polygon createNicaraguaPolygon() {
        return new Polygon(
    ...
    public static Polygon createCostaRicaPolygon() {
        return new Polygon(
    ...
    public static Polygon createPanamaPolygon() {
        return new Polygon(
